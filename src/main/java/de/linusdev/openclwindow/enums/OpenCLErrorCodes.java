...
public enum OpenCLErrorCodes {
    ...
    OpenCLErrorCodes(int code, @NotNull String description, @NotNull String @NotNull ... functions) {
        this.code = code;
    ...
    public static OpenCLErrorCodes checkError(int code) {
        for(OpenCLErrorCodes c : OpenCLErrorCodes.values()) {
